...
## [3.1.0](https://github.com/ApeWorX/revm/compare/revm-interpreter-v3.0.0...revm-interpreter-v3.1.0) - 2024-02-21
...
- *(db)* Set instruction result at outcome insert ([#1117](https://github.com/ApeWorX/revm/pull/1117))
